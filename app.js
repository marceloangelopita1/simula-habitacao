...
const moneyIds=['income','propertyValue','appraisal','fgtsUse','confirmedAid','purchaseCosts','principal','ownFunds','subsidyManual','fgtsTotalBalance','adminOverride','assessmentOverride'];
...
function showErrors(errors){
 const labels={income:'renda familiar',propertyValue:'valor do imóvel',principal:'financiamento',months:'prazo',subsidyManual:'subsídio',customMipPercent:'MIP',quotaOverride:'quota',propertyArea:'área',secondSharePercent:'participação',nominalOverride:'juros',confirmedAid:'aporte',fgtsUse:'FGTS',appraisal:'avaliação'};
